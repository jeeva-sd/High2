...
const ProTags = () => {
    return (
        <div>
            <section className="flex dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    <a href="/protags/youtube" title="View the new YouTube Tag Generator" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700">
                        <span className="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span className="text-sm font-medium">YT Generator is now live!</span>
                        <svg className="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path></svg>
                    </a>
                    <h1 className="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white"><span className='text-blue-600'>ProTags</span> - Tag Generator</h1>
            ...
            <section className='w-full flex flex-wrap justify-center dark:bg-gray-900 lg:px-20 md:px-10 px-5 pt-16 '>
                <div className='flex flex-wrap lg:w-8/12 md:w-full w-full lg:pt-16 pb-8'>
                    <span className="w-full lg:text-center md:text-center text-start font-extrabold leading-none text-gray-900 mb-4 md:text-4xl lg:text-4xl text-2xl dark:text-white">
            What's in ProTags?
                    </span>
                    <p className="w-full text-lg font-normal text-gray-500 lg:text-xl sm:px-16 dark:text-gray-400 lg:text-center md:text-center text-start">
            ProTags is a popular hashtag generation algorithm. Let's begin with some of the popular ProTags-powered tools, such as the YouTube tag generator and the Instagram hashtag generator.
                ...
                <div className="grid max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        <h2 className="max-w-2xl mb-4 md:text-4xl lg:text-4xl text-2xl font-extrabold tracking-tight leading-none dark:text-white">YouTube <span className='text-red-600'>Tag</span> Generator</h2>
              ...
              Our YouTube tag generator is a valuable tool that helps you in finding relevant tags for your videos based on the given title. ProTags analyze your video's content and provide suggestions for tags that align with your video's topic, increasing the chances of it being discovered by the right audience.
                ...
                <div className="grid max-w-screen-xl pt-8 lg:pb-8 md:pb-8 pb-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
                    ...
                    <div className="mr-auto place-self-center lg:col-span-7">
                        <h2 className="max-w-2xl mb-4 font-extrabold tracking-tight leading-none md:text-4xl lg:text-4xl text-2xl xl:text-4xl dark:text-white">Instagram <span className='text-violet-700'>HashTag</span> Generator</h2>
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
