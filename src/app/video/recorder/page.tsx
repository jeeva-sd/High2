...
const page = () => {
    ...
    const StepCard = ({
        ...
        <div className="relative p-6 bg-secondary rounded-xl shadow-md group hover:shadow-lg hover:scale-105 transition-all duration-300">
            <div className="absolute -top-5 left-5 w-12 h-12 flex items-center justify-center bg-primary text-primary-foreground rounded-full shadow-lg transition-all duration-300 group-hover:scale-110">
                <span className="text-2xl font-bold">{step}</span>
            </div>
            <h3 className="text-xl font-semibold text-primary mt-10">{title}</h3>
        ...
        <div>
            ...
            <main className="bg-background text-foreground min-h-screen">
                <section className="bg-background">
                    <div className="mx-auto max-w-screen-xl px-6 py-12 lg:pb-16 lg:pt-20">
                        <div className="md:grid md:grid-cols-12 lg:gap-12">
                            ...
                            <div className="hidden md:col-span-5 md:mt-0 md:flex justify-center">
                                <GiSoundWaves fontSize={180} className='text-muted-foreground' />
                            </div>
                        </div>
                    </div>

                    <div className="mx-auto max-w-screen-xl grid grid-cols-2 gap-6 px-6 sm:grid-cols-3 sm:gap-8 lg:grid-cols-4">
                    ...
                    <div className="py-16 px-6 mx-auto max-w-screen-xl text-center lg:py-20 lg:px-8">
                        <div className="grid gap-6 lg:grid-cols-2 lg:mb-12">
                            <figure className="flex flex-col justify-center items-center p-8 bg-muted border-b">
                            ...
                            <figure className="flex flex-col justify-center items-center p-8 bg-muted">
                                <blockquote className="mx-auto max-w-2xl">
                ...
                <section className="px-8 bg-background text-primary">
                    <h2 className="mb-4 text-3xl sm:text-4xl font-bold tracking-tight text-foreground text-center">How It Works?</h2>
                ...
                <section className="mt-44 px-6 mx-auto max-w-screen-xl">
                    <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Frequently asked questions</h2>
                    <div className="grid gap-16 pt-8 text-left border-t border-gray-200 dark:border-gray-700 md:grid-cols-2">
                        <div>
                            <div className="mb-10">
