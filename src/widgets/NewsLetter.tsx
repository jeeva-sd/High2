                ...
                <div className='mx-auto max-w-screen-md sm:text-center'>
                    ...
                    <form ref={emailRef} onSubmit={(e: any) => handleSubmit(e)}>
                        <div className='items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0'>
                            ...
                            <div>
                                {!subscribed && <button type='submit' className='disabled:bg-cyan-300  py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-blue-600 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-blue-800 focus:ring-4 focus:indigo-600 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800'>Subscribe</button>}
                            </div>
                        </div>
                        <div className='mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300'>We care about the protection of your data. <span className='font-medium text-cyan-600 cursor-pointer dark:text-primary-500 hover:underline'>Read our Privacy Policy</span>.</div>
                    </form>
                </div>
            </div>
        </section>
