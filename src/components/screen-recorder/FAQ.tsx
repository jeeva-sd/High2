    ...
    return (
        <h2 id={id}>
            <button
                ...
                border ${isActive ? 'border-b-0' : 'border-b-0'} border-gray-200 rounded-t-xl 
            ...
            {isActive && (
                <div
                    id={id}
                    aria-labelledby={id}
                    className="p-5 border border-b-0 border-gray-200 dark:border-gray-700 bg-sky-50 w-auto">
